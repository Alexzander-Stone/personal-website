...
The live draft toy that used to sit here depended on a local backend, so I replaced it with a public-safe proof page. The updated demo shows a sanitized benchmark viewer instead of exposing raw model internals or pretending the public site is a live competitive draft assistant.

[View the Derzan's Draft public proof](/derzans-draft/)
