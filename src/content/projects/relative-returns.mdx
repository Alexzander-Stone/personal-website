...
author: 'Alex Stone'
image:
    url: '/projects/relative-returns/hero.jpeg'
...
Politicians from both parties use stock charts as evidence that their administration is "working" ([Pam Bondi, House Judiciary hearing, Feb. 11, 2026](https://www.cnbc.com/2026/02/11/trump-pam-bondi-hearing-stock-epstein-judiciary-dow.html); [President Trump remarks on Dow 30,000, Nov. 24, 2020](https://trumpwhitehouse.archives.gov/briefings-statements/remarks-president-trump-economy-112420-2/); [Biden campaign post on record highs, Dec. 15, 2023](https://www.cnbc.com/2023/12/15/biden-flaunts-stock-market-record-highs-mocks-trump-for-predicting-collapse.html)). If that's the claim, this page measures it directly: US returns versus global peers, on aligned trading days, with one method applied to every administration.
