...
author: 'Alex Stone'
image:
    url: '/projects/relative-returns/hero.png'
...
Politicians from both parties use stock charts as evidence that their administration is "working" ([Pam Bondi, House Judiciary hearing, Feb. 11, 2026](https://www.c-span.org/clip/house-committee/attorney-general-delivers-opening-statement-to-house-judiciary-committee/5192722); [President Trump remarks on Dow 30,000, Nov. 24, 2020](https://trumpwhitehouse.archives.gov/briefings-statements/remarks-president-trump-economy-112420-2/); [Biden campaign post on record highs, Dec. 15, 2023](https://www.cnbc.com/2023/12/15/biden-flaunts-stock-market-record-highs-mocks-trump-for-predicting-collapse.html)). If that's the claim, this page measures it directly: US returns versus global peers, on aligned trading days, with one method applied to every administration.
...
- Confidence bands use geometric Brownian motion quantiles ([Sigman, 2006](https://www.columbia.edu/~ks20/FE-Notes/4700-07-Notes-GBM.pdf)): `band(n) = S0 * exp((mu - sigma^2/2)*n +/- k*sigma*sqrt(n))` where `k=1` (~68%) or `k=2` (~95%).
